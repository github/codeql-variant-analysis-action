...
import { toS, toMd, interpret } from "./interpret.js";
...
test("relative URL conversion", (t) => {
    ...
    const result = toS(input, "dsp-testing/qc-demo-github-certstore", "/home/runner/work/qc-demo-github-certstore/qc-demo-github-certstore", "mybranch");
...
test("entire row converted correctly", (t) => {
    ...
    const result = toMd(input, "dsp-testing/qc-demo-github-certstore", "/home/runner/work/qc-demo-github-certstore/qc-demo-github-certstore", "mybranch");
...
test("entire result set converted correctly", async (t) => {
    ...
    await interpret(w, results, "dsp-testing/qc-demo-github-certstore", "/home/runner/work/qc-demo-github-certstore/qc-demo-github-certstore", "mybranch");
