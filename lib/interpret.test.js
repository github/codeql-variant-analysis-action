...
const results = json_result_generated_1.Convert.toJSONResult(`{
    "#select": {
      "columns": [
        {
          "name": "e",
...
const windowsResults = json_result_generated_1.Convert.toJSONResult(`{
  "#select": {
    "columns": [
      {
        "name": "f",
...
ava_1.default("malformed result JSON throws error", (t) => {
    t.throws(() => json_result_generated_1.Convert.toJSONResult(badResults));
});
