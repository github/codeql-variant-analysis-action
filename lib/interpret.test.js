...
(0, ava_1.default)("relative URL conversion", (t) => {
    const result = (0, interpret_1.toS)(results["#select"].tuples[0][0], "dsp-testing/qc-demo-github-certstore", "/home/runner/work/qc-demo-github-certstore/qc-demo-github-certstore", "mybranch");
...
(0, ava_1.default)("absolute URL left alone", (t) => {
    const result = (0, interpret_1.toS)(results["#select"].tuples[0][0], "dsp-testing/qc-demo-github-certstore", "/tmp");
...
(0, ava_1.default)("entire row converted correctly", (t) => {
    const result = (0, interpret_1.toMd)(results["#select"].tuples[0], "dsp-testing/qc-demo-github-certstore", "/home/runner/work/qc-demo-github-certstore/qc-demo-github-certstore", "mybranch");
...
(0, ava_1.default)("entire result set converted correctly", async (t) => {
    let output = "";
    ...
    await (0, interpret_1.interpret)(w, results, "dsp-testing/qc-demo-github-certstore", "/home/runner/work/qc-demo-github-certstore/qc-demo-github-certstore", "mybranch");
...
(0, ava_1.default)("windows results conversion", async (t) => {
    ...
    await (0, interpret_1.interpret)(w, windowsResults, "dsp-testing/test-electron", "D:\\a\\test-electron\\test-electron", "mybranch");
