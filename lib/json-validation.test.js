...
for (const schema of json_validation_1.schemaNames) {
    (0, ava_1.default)(`throws error for invalid ${schema}`, (t) => {
        ...
        const error = t.throws(() => (0, json_validation_1.validateObject)(testObj, schema));
...
(0, ava_1.default)("can successfully validate QueryMetadata", (t) => {
    const obj = {
        kind: "problem",
    };
    t.notThrows(() => (0, json_validation_1.validateObject)(obj, "queryMetadata"));
});
...
(0, ava_1.default)("can successfully validate Policy", (t) => {
    /* eslint-disable @typescript-eslint/naming-convention */
    const obj = {
    ...
    /* eslint-enable @typescript-eslint/naming-convention */
    t.notThrows(() => (0, json_validation_1.validateObject)(obj, "policy"));
});
