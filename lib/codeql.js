...
exports.writeQueryRunMetadataToFile = exports.getSarifResultCount = exports.injectVersionControlInfo = exports.getRemoteQueryPackDefaultQuery = exports.getDatabaseMetadata = exports.getBqrsInfo = exports.runQuery = exports.downloadDatabase = void 0;
...
async function runQuery(codeql, database, nwo, queryPack) {
    ...
    fs_1.default.renameSync(path_1.default.join(cur, entry.name), bqrsFilePath);
    ...
    if (isSarif) {
        ...
        const sarifFilePath = path_1.default.join("results", "results.sarif");
        fs_1.default.writeFileSync(sarifFilePath, sarif);
    ...
    writeQueryRunMetadataToFile(metadataFilePath, nwo, resultCount, (_c = dbMetadata.creationMetadata) === null || _c === void 0 ? void 0 : _c.sha);
