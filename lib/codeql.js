...
async function runQuery(codeql, database, nwo, queryPack) {
    ...
    const outputPromises = [
        ...
        outputSarif(codeql, bqrs, compatibleQueryKinds, databaseName, sourceLocationPrefix, nwo, ((_c = dbMetadata.creationMetadata) === null || _c === void 0 ? void 0 : _c.sha) || "HEAD"),
...
async function outputSarif(codeql, bqrs, compatibleQueryKinds, databaseName, sourceLocationPrefix, nwo, ref) {
    let kind;
