...
async function runQuery(codeql, database, nwo, queryPack) {
    ...
    const metadataFilePath = outputQueryRunMetadata(nwo, resultCount, (_c = dbMetadata.creationMetadata) === null || _c === void 0 ? void 0 : _c.sha);
 ...
 */
function outputQueryRunMetadata(nwo, resultCount, sha) {
