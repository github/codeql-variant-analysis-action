...
async function runQuery(codeql, database, nwo, queryPack) {
    ...
    const outputPromises = [
        ...
        outputSarif(codeql, bqrs, nwo, ((_c = dbMetadata.creationMetadata) === null || _c === void 0 ? void 0 : _c.sha) || "HEAD", compatibleQueryKinds, databaseName, sourceLocationPrefix),
...
async function outputSarif(codeql, bqrs, nwo, databaseSHA, compatibleQueryKinds, databaseName, sourceLocationPrefix) {
    let kind;
