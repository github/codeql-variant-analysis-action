...
exports.injectVersionControlInfo = exports.getRemoteQueryPackDefaultQuery = exports.getDatabaseMetadata = exports.getBqrsInfo = exports.runQuery = exports.downloadDatabase = void 0;
...
async function runQuery(codeql, database, nwo, queryPack) {
    ...
    const databaseSHAFile = path_1.default.join("results", "sha.txt");
    fs_1.default.writeFileSync(databaseSHAFile, ((_b = dbMetadata.creationMetadata) === null || _b === void 0 ? void 0 : _b.sha) || "");
    await (0, exec_1.exec)(codeql, [
        "database",
        "run-queries",
        "--additional-packs",
    ...
    const outputPromises = [
        ...
        outputMd(codeql, bqrs, nwo, ((_c = dbMetadata.creationMetadata) === null || _c === void 0 ? void 0 : _c.sha) || "HEAD", compatibleQueryKinds, sourceLocationPrefix),
        outputSarif(codeql, bqrs, nwo, compatibleQueryKinds, databaseName, sourceLocationPrefix, (_d = dbMetadata.creationMetadata) === null || _d === void 0 ? void 0 : _d.sha),
        outputResultCount(bqrsInfo),
    ];
    return [bqrs, nwoFile, databaseSHAFile].concat(...(await Promise.all(outputPromises)));
}
...
async function outputSarif(codeql, bqrs, nwo, compatibleQueryKinds, databaseName, sourceLocationPrefix, databaseSHA) {
    let kind;
