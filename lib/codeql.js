...
async function runQuery(codeql, database, nwo, queryPack) {
    ...
    const outputPromises = [
        ...
        isSarif
            ? outputSarifAndCount(codeql, bqrs, nwo, compatibleQueryKinds, databaseName, sourceLocationPrefix, (_d = dbMetadata.creationMetadata) === null || _d === void 0 ? void 0 : _d.sha)
