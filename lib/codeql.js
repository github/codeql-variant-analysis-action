...
libraryPathDependencies: codeql-${language}`);
    ...
    await (0, interpret_1.interpret)(s, jsonResults, nwo, sourceLocationPrefix);
}
exports.runQuery = runQuery;
async function downloadDatabase(repoId, language, signedAuthToken, pat) {
    ...
    return (0, tool_cache_1.downloadTool)(`https://api.github.com/repositories/${repoId}/code-scanning/codeql/databases/${language}`, `${repoId}.zip`, authHeader);
}
