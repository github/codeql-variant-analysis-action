...
exports.BQRSInfo2 = exports.getDatabaseSHA = exports.runQuery = exports.downloadDatabase = void 0;
...
let BQRSInfo2 = class BQRSInfo2 extends ts_serializer_1.Serializable {
    constructor() {
        super(...arguments);
        this.resultSets = [];
        this.compatibleQueryKinds = [];
    }
};
__decorate([
    (0, ts_serializer_1.SerializeProperty)({
        map: "result-sets",
    })
], BQRSInfo2.prototype, "resultSets", void 0);
__decorate([
    (0, ts_serializer_1.SerializeProperty)({
        map: "compatible-query-kinds",
    })
], BQRSInfo2.prototype, "compatibleQueryKinds", void 0);
BQRSInfo2 = __decorate([
    (0, ts_serializer_1.Serialize)({})
], BQRSInfo2);
exports.BQRSInfo2 = BQRSInfo2;
...
async function outputResultCount(bqrsInfo) {
    ...
    const selectResultSet = bqrsInfo["result-sets"].find((resultSet) => resultSet.name === "#select");
    if (!selectResultSet) {
        throw new Error("No result set named #select");
    }
    fs_1.default.writeFileSync(count, selectResultSet.rows.toString(), "utf8");
    return [count];
}
/**
