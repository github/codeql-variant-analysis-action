...
`);
        t.is((0, codeql_1.getDatabaseMetadata)(tmpDir).creationMetadata?.sha, "ccf1e13626d97b009b4da78f719f028d9f7cdf80");
        t.is((0, codeql_1.getDatabaseMetadata)(tmpDir).creationMetadata?.cliVersion, "2.7.2");
    }
    finally {
        await (0, io_1.rmRF)(tmpDir);
    }
...
primaryLanguage: "javascript"
`);
        t.is((0, codeql_1.getDatabaseMetadata)(tmpDir).creationMetadata?.sha, undefined);
    }
    finally {
        await (0, io_1.rmRF)(tmpDir);
    }
