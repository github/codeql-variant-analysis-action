...
(0, ava_1.default)("getting the default query from a pack", async (t) => {
    const tmpDir = fs_1.default.mkdtempSync("tmp");
    try {
        fs_1.default.writeFileSync(path_1.default.join(tmpDir, "qlpack.yml"), `---
library: false
...
defaultSuite:
  ...
  - query: x/query.ql      
`);
        t.is((0, codeql_1.getQueryPackDefaultQuery)(tmpDir), "x/query.ql");
    }
    finally {
        await (0, io_1.rmRF)(tmpDir);
    }
});
(0, ava_1.default)("getting the default query fails gracefully ", async (t) => {
    const tmpDir = fs_1.default.mkdtempSync("tmp");
    try {
        fs_1.default.writeFileSync(path_1.default.join(tmpDir, "qlpack.yml"), `---
library: false
...
defaultSuite:
  - description: Query suite for remote query
`);
        t.is((0, codeql_1.getQueryPackDefaultQuery)(tmpDir), undefined);
    }
    finally {
        await (0, io_1.rmRF)(tmpDir);
    }
