...
async function getQueryText() {
    ...
    if (queryPackUrl !== undefined) {
        ...
        const queryFile = (0, codeql_1.getQueryPackDefaultQuery)(queryPack);
        if (queryFile === undefined) {
            return "Unable to display executed query";
        }
        else {
            return await fs_1.default.promises.readFile(path_1.default.join(queryPack, queryFile), "utf-8");
        }
    }
    else {
...
async function uploadCSVs(resultArtifacts, artifactClient) {
