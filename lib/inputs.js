...
function getVariantAnalysisId() {
    return parseInt((0, core_1.getInput)("variant_analysis_id", { required: true }));
}
exports.getVariantAnalysisId = getVariantAnalysisId;
function getSignedAuthToken() {
    return (0, core_1.getInput)("signed_auth_token", { required: true });
}
exports.getSignedAuthToken = getSignedAuthToken;
function getRepos() {
    return (0, json_validation_1.validateObject)(JSON.parse((0, core_1.getInput)("repositories", { required: true })), "repoArray");
}
...
async function getInstructions() {
    ...
    return (0, json_validation_1.validateObject)(JSON.parse(await fs.promises.readFile(filePath, "utf-8")), "instructions");
}
