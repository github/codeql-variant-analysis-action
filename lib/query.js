...
async function uploadRepoResult(controllerRepoId, variantAnalysisId, repo, runQueryResult) {
    ...
    const policy = await (0, gh_api_client_1.getPolicyForRepoArtifact)(controllerRepoId, variantAnalysisId, repo.id, runQueryResult.sarifFileSize || runQueryResult.bqrsFileSize);
